...
<template>
  <div class="flex items-center bg-monero-grey text-white p-3 relative">
    <div class="container mx-auto flex flex-row gap-3 justify-center">
      ...
      <span v-if="czKoruna === 'true'" class="inline-flex items-center rounded-md bg-yellow-50 px-2 py-1 text-2xl font-medium text-yellow-600 ring-1 ring-inset ring-yellow-500/10">1 XMR = {{ sessionStore.getRate('czk') }} Kč</span>
